...
function initInterface() {
    ...
    document.getElementById("specular-color").addEventListener("input", function (event) {
        var hexcolor = event.target.value.substring(1);
        var rgbHex = hexcolor.match(/.{1,2}/g);
...
function buildModelViewProj() {
    ...
    // set light color
    var lambhexcolor = document.getElementById("ambient-color").value.substring(1).match(/.{1,2}/g);
    lightAmbient = vec4.fromValues(
    ...
    var ldifhexcolor = document.getElementById("diffuse-color").value.substring(1).match(/.{1,2}/g);
    lightDiffuse = vec4.fromValues(
    ...
    var lspehexcolor = document.getElementById("specular-color").value.substring(1).match(/.{1,2}/g);
    lightSpecular = vec4.fromValues(
